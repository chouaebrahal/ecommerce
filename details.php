...
$get_user = "select * from customers where customer_email='$user_session'";
...
$user_session = $_SESSION['receveur_email'];

$get_user = "select * from receveurs where receveur_email='$user_session'";

$run_user = mysqli_query($con,$get_user);

$row_user = mysqli_fetch_array($run_user);

$user_id = $row_user['receveur_id'];
}

$select_wishlist = "select * from wishlist where user_id='$user_id' AND product_id='$pro_id'";
...
$insert_wishlist = "insert into wishlist (user_id,product_id) values ('$user_id','$pro_id')";
...
<h3><a href='$pro_url' style='overflow: hidden;
text-overflow: ellipsis;
display: -webkit-box;
-webkit-line-clamp: 1; /* number of lines to show */
-webkit-box-orient: vertical;text-decoration:none;' >$pro_title</a></h3>
...
<img src='admin_area/product_images/$pro_img1' class='img-responsive' style='height:250px;width:100%;'>
