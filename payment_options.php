...
$session_email = $_SESSION['receveur_email'];

$select_receveur = "select * from receveurs where receveur_email='$session_email'";

$run_receveur = mysqli_query($con,$select_receveur);

$row_receveur= mysqli_fetch_array($run_receveur);

$user_id = $row_receveur['receveur_id'];
}
...
<a href="order.php?c_id=<?php echo $user_id; ?>">Pay Off line</a>
