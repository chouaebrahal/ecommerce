...
<input type="radio" value='customer' name='type_user' ><label>customer</label>
<span style="display:inline-block;width:10px;"></span>
<input type="radio" value='receveur' name='type_user' ><label>receveur</label>
</div>
...
move_uploaded_file($c_image_tmp,"user/receveur_images/$c_image");

$get_email = "select * from receveurs where receveur_email='$c_email'";
...
$insert_customer = "insert into receveurs (receveur_name,receveur_email,receveur_pass,receveur_country,receveur_city,receveur_contact,receveur_address,receveur_image,receveur_ip,receveur_confirm_code) values ('$c_name','$c_email','$c_pass','$c_country','$c_city','$c_contact','$c_address','$c_image','$c_ip','$customer_confirm_code')";
...
$_SESSION['receveur_email']=$c_email;
...
}elseif($_POST['type_user']=="customer"){
  $c_name = $_POST['c_name'];
...
move_uploaded_file($c_image_tmp,"user/customer_images/$c_image");
