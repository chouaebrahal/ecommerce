...
if(isset($_SESSION['customer_email'])){
    ...
    $update_receveur_order = "update receveur_orders set order_status='$complete' where order_id='$update_id'";
$run_receveur_order = mysqli_query($con,$update_receveur_order);

$update_pending_order = "update receveur_pending_orders set order_status='$complete' where order_id='$update_id'";
