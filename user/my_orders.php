...
if(isset($_SESSION['customer_email'])){
    ...
    $get_orders = "select * from receveur_orders where receveur_id='$user_id'";
...
<td>
<a href="delete_order.php?order_id=<?php echo $order_id; ?>" target="blank" class="btn btn-primary btn-sm" > Cancel order </a>
</td>
