...
if(isset($_SESSION['customer_email'])){
    ...
    $receveur_session = $_SESSION['receveur_email'];

$get_receveur = "select * from receveurs where receveur_email='$receveur_session'";

$run_receveur = mysqli_query($con,$get_receveur);

$row_receveur = mysqli_fetch_array($run_receveur);

$receveur_image = $row_receveur['receveur_image'];

$receveur_name = $row_receveur['receveur_name'];
...
<h3 align='center' class='panel-title'> Name : $receveur_name </h3>
